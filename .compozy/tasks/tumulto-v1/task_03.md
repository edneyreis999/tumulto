...
# Concluir legibilidade, acessibilidade e build local

## Resultado entregável
Protótipo legível com assets reaproveitados, menus acessíveis, erros e build estático.
...
## Testes e evidência
IT-006, E2E-004, E2E-005.
Suites e entradas/resultados em `_tests.md`; verificações integradas restantes pertencem à task_07. Evidência desta tarefa em `evidence/task_03/` e `memory/task_03.md`.
